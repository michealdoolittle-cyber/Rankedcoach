...
**Status (2026-07-09 follow-up):** The cache-bust gap called out in mobile bug fix #13 is now closed, and the intensity follow-up is now shipped in code: Radiant Focus keeps the longer, brighter glint plateau plus the structural avatar-ring treatment, while Omen Night keeps the stronger structural ring pass and opacity floor on mobile. Desktop remains on the already-shipped color treatment, and the named-card gallery layout stayed intact on the fresh follow-up pass.
