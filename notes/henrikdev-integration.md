...
**Independent verification (2026-07-11): PASSED.** The known-match target and all six added formula families now have direct test coverage. Three retained matches from 2024, 2025, and 2026 also match direct Henrik K/D/A, ACS, ADR, HS%, KAST, result, map, agent, and season values. The Stats selector now explains the oldest provider-retained date for Henrik profiles rather than leaving the historical ceiling unexplained.
