...
**Gap closed 2026-07-11:** the "Win Streak"/"Loss Streak" cards now use deterministic Valorant-native variants from the shared vocabulary bank and Henrik-backed source labels. The adjacent no-data, logging, tilt, repeated-focus, confidence, and loss-plus-tilt cards were re-checked and rewritten where they still used generic analytics language.
