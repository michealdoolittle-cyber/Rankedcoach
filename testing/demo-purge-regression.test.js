...
const start = appSource.indexOf("function isDemoFixtureMatch");
const end = appSource.indexOf("function isCurrentValorantStatsLabel", start);

assert.notEqual(start, -1, "isDemoFixtureMatch should exist in app.js");
...
this.helpers = { isDemoFixtureMatch, purgeDemoFixtureMatches, getMatchSeasonLabel, isHenrikSyncMatch };`, context, {
  filename: "public/app.js demo helpers"
});

const { isDemoFixtureMatch, purgeDemoFixtureMatches, getMatchSeasonLabel } = context.helpers;
...
const sourceDemo = { id: "demo-match-1", source: "demo-fixture", metadata: { demoAct: "Demo Season" } };
