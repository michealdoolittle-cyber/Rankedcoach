...
142. Weapon variety across a match (not committing to one gun regardless of round context) generally correlates with better economy discipline and situational awareness. A player's declared weapon-style preference may be compared with the retained round-level weapon mix only after enough reported weapon rounds; a mismatch means the stated preference and observed buys differ, not that either choice is automatically wrong.
