  ...
  const GAMESENSE_MAPS = [
    {
      ...
      weaponSuggestions: [
        ...
        { weapon: "Operator", image: "/assets/weapons/operator.png", category: "sniper", fit: "Strong sniper fit", evidence: "0.80 kills per round | 220 average damage", locations: "B Long, A Tower, A Short", conversion: "Conversion read: stronger than a shotgun while the first duel stays long; Judge and Bucky gain value once Hookah or Lamps is the planned contact.", note: "Long lanes create early picks, but the lack of mid makes a missed read expensive. Pair it with an escape tool or planned teleporter rotation." },
        { weapon: "Ghost", image: "/assets/weapons/ghost.png", category: "pistol", fit: "Pistol-round fit", evidence: "500 credits | one-shot headshot through 30m", locations: "A Short, Bath, B Long", note: "The quiet, accurate first shot fits Bind's early lane fights while keeping utility in the buy." },
        { weapon: "Judge", image: "/assets/weapons/judge.png", category: "shotgun", fit: "Close conversion rival", evidence: "1,850 credits | five-shell magazine", locations: "Hookah, Lamps, U-Hall", conversion: "Conversion read: more repeatable than an Operator when the setup guarantees two close contacts; much weaker if attackers can reset to Long or Bath.", note: "Commit it to a compact choke and plan the rifle recovery after the first conversion." },
    ...
    },
    {
      ...
      weaponSuggestions: [
        ...
        { weapon: "Operator", image: "/assets/weapons/operator.png", category: "sniper", fit: "High-value sniper", evidence: "0.80 kills per round | 220 average damage", locations: "A Main, B Main, Mid Nest", conversion: "Conversion read: the Operator wins the map-wide comparison; Judge or Bucky only catches up inside a deliberately protected Tunnel or Hall pocket.", note: "The map gives repeated long-lane shots. Mobility or teleport tools make the weapon safer after contact." },
        { weapon: "Sheriff", image: "/assets/weapons/sheriff.png", category: "pistol", fit: "Long-lane pistol", evidence: "800 credits | one-shot headshot through 30m", locations: "A Main, Mid, B Main", note: "Use cover to keep the decisive duel inside its one-shot range; full-map peeks expose the long-range damage falloff." },
        { weapon: "Bucky", image: "/assets/weapons/bucky.png", category: "shotgun", fit: "Low conversion fit", evidence: "850 credits | five-shell magazine", locations: "A Hall, B Tunnel", conversion: "Conversion read: cheaper than a sniper but too location-dependent to match Operator conversions across Breeze's open sites.", note: "Treat it as a single protected ambush, then recover a ranged weapon before rotating into open space." },
    ...
    },
    {
      ...
      weaponSuggestions: [
        ...
        { weapon: "Operator", image: "/assets/weapons/operator.png", category: "sniper", fit: "Conditional sniper", evidence: "0.80 kills per round | 220 average damage", locations: "A Ramps, B Main, Mid", conversion: "Conversion read: excellent for the opening lane, but Judge and Bucky can convert more reliably after attackers enter Split's tight towers, vents, and site pockets.", note: "Take the opening pick beside an exit. Do not drag the slow cycle into a forced close retake." },
        { weapon: "Ghost", image: "/assets/weapons/ghost.png", category: "pistol", fit: "Flexible pistol fit", evidence: "500 credits | one-shot headshot through 30m", locations: "A Main, Mid, B Main", note: "Its first-shot accuracy covers the medium lanes without consuming the utility budget needed to break Split's chokes." },
        { weapon: "Judge", image: "/assets/weapons/judge.png", category: "shotgun", fit: "High close conversion", evidence: "1,850 credits | five-shell magazine", locations: "B Tower, Vents, A Heaven", conversion: "Conversion read: can beat Operator reliability when the route forces repeated close fights, but loses immediately if Mid or Main opens the range.", note: "Anchor one compact route, vary the corner, and plan how the weapon leaves the round after the first close duel." },
