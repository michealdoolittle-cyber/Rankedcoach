...
(function () {
  ...
  const agents = [
    {
      ...
      abilities: [
        ability("updraft", "Updraft", "Q - Basic", "jett", "Instant vertical movement that changes elevation before or during a fight.", { Cost: "150 credits", Charges: "1", Recharge: "No", Damage: "None" }, "Reach unexpected elevation, clear vertical utility, or combine with Blade Storm.", "Use it with a clear landing plan. The weapon re-equip delay makes unsupported airtime punishable.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/4cbc968f05713579aae9464c5a16dc3f6863f943.mp4?accountingTag=VAL", "Jett Updraft ability demo")),
        ability("tailwind", "Tailwind", "E - Signature", "jett", "Instant movement that propels Jett in her current movement direction or forward while stationary.", { Cost: "Free", Charges: "1", Recharge: "After 2 kills", Damage: "None" }, "Create entry space or escape after an Operator shot or opening duel.", "Use the dash with a clear destination. It should end behind cover or inside a planned Cloudburst.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/ec6b3cf1f8ac09d597b0193de1d7bb81335b40e4.mp4?accountingTag=VAL", "Jett Tailwind ability demo")),
        ability("cloudburst", "Cloudburst", "C - Basic", "jett", "A steerable vision-blocking cloud for a very short crossing window.", { Cost: "200 credits", Charges: "2", Duration: "2.5 seconds", Damage: "None" }, "Break one sightline long enough to dash, cross, isolate, or retrieve the spike.", "Small one-ways are possible, but the short duration makes them a momentary duel tool rather than controller coverage.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/3353597819f0c032d56ff947d9762368b4ee6c6b.mp4?accountingTag=VAL", "Jett Cloudburst ability demo")),
        ability("blade-storm", "Blade Storm", "X - Ultimate", "jett", "Equip five accurate knives; single-fire kills restore knives while alternate fire shotguns the remaining knives in one spread.", { Cost: "8 ultimate points", Ammo: "5 knives", Damage: "50 body / 150 head", Falloff: "No single-fire falloff" }, "Preserve economy, fight accurately while moving, and pair vertical movement with a weapon that stays precise.", "Single-fire for reliable resets. Alternate fire is a close-range commitment and does not restore knives on a kill.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/667770571300e065b332617e5c8f2e009ed88928.mp4?accountingTag=VAL", "Jett Blade Storm ability demo"))
      ]
    },
    {
    ...
    },
    {
      ...
      abilities: [
        ability("shrouded-step", "Shrouded Step", "C - Basic", "omen", "A short targeted teleport after a brief channel.", { Cost: "100 credits", Charges: "2", Recharge: "No", Damage: "None" }, "Reach elevation, escape utility, cross a watched gap, or reposition after making noise elsewhere.", "Hide the channel sound or force the enemy to watch multiple landing points. Unsupported open-ground teleports are a gamble.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/33550fee410c5a55ea8832f41827a12aaddb686f.mp4?accountingTag=VAL", "Omen Shrouded Step ability demo")),
        ability("paranoia", "Paranoia", "Q - Basic", "omen", "A shadow-phase projectile that Nearsights and Deafens everyone it touches while passing through terrain and objects.", { Cost: "250 credits", Charges: "1", Debuff: "About 2 seconds", Damage: "None" }, "Start a coordinated swing through a narrow lane or disable a defender holding behind cover.", "Call the path before casting. It can hit teammates, so align the projectile beside their approach rather than through them.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/f401fc788f3182b6d5aa25af6056c842117b1b36.mp4?accountingTag=VAL", "Omen Paranoia ability demo")),
        ability("dark-cover", "Dark Cover", "E - Signature", "omen", "A long-lasting spherical smoke placed through Omen's tactical targeting view.", { Cost: "1 free; extra charge 150", Charges: "2", Duration: "15 seconds", Recharge: "Cooldown" }, "Remove named angles, sell pressure across the map, and preserve a smoke for the late round.", "One-ways are possible on ledges and boxes, but require consistent placement. A complete execute smoke matters more than a fragile trick setup.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/ba0b035a5ff2bb8d9487ba461b3d15900ff50f6b.mp4?accountingTag=VAL", "Omen Dark Cover ability demo")),
        ability("from-the-shadows", "From the Shadows", "X - Ultimate", "omen", "Teleport anywhere as a destructible Shade, with the option to cancel and return.", { Cost: "7 ultimate points", Range: "Map-wide", Damage: "None", Recharge: "No" }, "Recover the spike, force defenders to turn, sell a fake, or convert information into a fast rotation.", "Choose a landing with cover and a reason. A cancel can still create value if it forces the enemy to abandon position.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/252cf8ad86b6aca6210ba93ea856f52708476eba.mp4?accountingTag=VAL", "Omen From the Shadows ability demo"))
      ]
    },
    {
    ...
    },
    {
      ...
      abilities: [
        ability("barrier-orb", "Barrier Orb", "C - Basic", "sage", "A four-segment wall that fortifies after deployment and blocks movement and bullets.", { Cost: "300 credits", Charges: "1", Duration: "40 seconds", Health: "600 per fortified segment" }, "Delay a choke, secure a plant, reshape an angle, or elevate a teammate.", "Off-angle walls are possible, but every exposed segment can give attackers a safe breaking target. Build for a specific fight or timing.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/a79b1d6838cee5572b428babd74a2db0c07f4ea5.mp4?accountingTag=VAL", "Sage Barrier Orb ability demo")),
        ability("slow-orb", "Slow Orb", "Q - Basic", "sage", "A lingering field that slows movement and reduces dash speed.", { Cost: "200 credits each", Charges: "2", Duration: "7 seconds", Damage: "None" }, "Hold attackers in damage utility, stop a fast hit, and make a retake swing easier to time.", "Throw it where enemies must cross, not where they already finished moving. Layer two slows only when the extra time changes the round.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/45053483528b96cbe003ac39e6b53c9866d5fea6.mp4?accountingTag=VAL", "Sage Slow Orb ability demo")),
        ability("healing-orb", "Healing Orb", "E - Signature", "sage", "A heal-over-time for an ally or a weaker self-heal for Sage.", { Cost: "Free", Charges: "1", Recharge: "Cooldown", Damage: "None" }, "Restore a teammate who can take another meaningful fight and preserve armor value.", "Do not cross an exposed lane just to heal. Ask whether the healed player can actually rejoin the round.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/a247d196383136d3de15b4d6d9c816e3c8054ba0.mp4?accountingTag=VAL", "Sage Healing Orb ability demo")),
        ability("resurrection", "Resurrection", "X - Ultimate", "sage", "Revive a dead ally after a vulnerable channel and return them at full health.", { Cost: "7 ultimate points", Charges: "1", Health: "Full health", Damage: "None" }, "Recover a key weapon, restore numbers, or force defenders to contest the body.", "Clear the body and name the revived player's escape route first. A resurrection that immediately dies spends the ultimate without restoring pressure.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/df83929ed5da349c37a5bf4600c2b55010c72402.mp4?accountingTag=VAL", "Sage Resurrection ability demo"))
      ]
    },
    {
  ...
  const weaponCatalog = {
    ...
    ares: weapon("ares", "Ares", 1600, 50, "13 rounds/sec", "High", [{ range: "0-30m", head: 75, body: 30, legs: 25.5 }, { range: "30-50m", head: 70, body: 28, legs: 23.8 }], "Use sustained fire for smoke spam, wall pressure, and anti-rush holds where the wind-up can work for you."),
    odin: weapon("odin", "Odin", 3200, 100, "12 rounds/sec", "High", [{ range: "0-30m", head: 95, body: 38, legs: 32.3 }, { range: "30-50m", head: 77.5, body: 31, legs: 26.35 }], "Use the high penetration and deep magazine to deny predictable paths, break utility, and punish grouped pushes."),
