...
(function () {
  ...
  const agents = [
    ...
    },
    {
      ...
      abilities: [
        ability("shrouded-step", "Shrouded Step", "C - Basic", "omen", "A short targeted teleport after a brief channel.", { Cost: "100 credits", Charges: "2", Recharge: "No", Damage: "None" }, "Reach elevation, escape utility, cross a watched gap, or reposition after making noise elsewhere.", "Hide the channel sound or force the enemy to watch multiple landing points. Unsupported open-ground teleports are a gamble.", { videoId: "NQnVPvXGQE0", title: "How To Master Omen In 60 Seconds (Valorant Tips)" }),
        ability("paranoia", "Paranoia", "Q - Basic", "omen", "A wall-piercing projectile that Nearsights and Deafens everyone it touches.", { Cost: "250 credits", Charges: "1", Debuff: "About 2 seconds", Damage: "None" }, "Start a coordinated swing through a narrow lane or disable a defender holding behind cover.", "Call the path before casting. It can hit teammates, so align the projectile beside their approach rather than through them.", { videoId: "NQnVPvXGQE0", title: "How To Master Omen In 60 Seconds (Valorant Tips)" }),
        ability("dark-cover", "Dark Cover", "E - Signature", "omen", "A long-lasting spherical smoke placed through Omen's tactical targeting view.", { Cost: "1 free; extra charge 150", Charges: "2", Duration: "15 seconds", Recharge: "Cooldown" }, "Remove named angles, sell pressure across the map, and preserve a smoke for the late round.", "One-ways are possible on ledges and boxes, but require consistent placement. A complete execute smoke matters more than a fragile trick setup.", { videoId: "NQnVPvXGQE0", title: "How To Master Omen In 60 Seconds (Valorant Tips)" }),
        ability("from-the-shadows", "From the Shadows", "X - Ultimate", "omen", "Teleport anywhere as a destructible Shade, with the option to cancel and return.", { Cost: "7 ultimate points", Range: "Map-wide", Damage: "None", Recharge: "No" }, "Recover the spike, force defenders to turn, sell a fake, or convert information into a fast rotation.", "Choose a landing with cover and a reason. A cancel can still create value if it forces the enemy to abandon position.", { videoId: "NQnVPvXGQE0", title: "How To Master Omen In 60 Seconds (Valorant Tips)" })
      ]
    },
    {
    ...
    },
    {
      ...
      abilities: [
        ability("barrier-orb", "Barrier Orb", "C - Basic", "sage", "A four-segment wall that fortifies after deployment and blocks movement and bullets.", { Cost: "300 credits", Charges: "1", Duration: "40 seconds", Health: "600 per fortified segment" }, "Delay a choke, secure a plant, reshape an angle, or elevate a teammate.", "Off-angle walls are possible, but every exposed segment can give attackers a safe breaking target. Build for a specific fight or timing.", { videoId: "XtmXACKYEZw", title: "How To Play SAGE Like A RADIANT (Valorant Tips)" }),
        ability("slow-orb", "Slow Orb", "Q - Basic", "sage", "A lingering field that slows movement and reduces dash speed.", { Cost: "200 credits each", Charges: "2", Duration: "7 seconds", Damage: "None" }, "Hold attackers in damage utility, stop a fast hit, and make a retake swing easier to time.", "Throw it where enemies must cross, not where they already finished moving. Layer two slows only when the extra time changes the round.", { videoId: "XtmXACKYEZw", title: "How To Play SAGE Like A RADIANT (Valorant Tips)" }),
        ability("healing-orb", "Healing Orb", "E - Signature", "sage", "A heal-over-time for an ally or a weaker self-heal for Sage.", { Cost: "Free", Charges: "1", Recharge: "Cooldown", Damage: "None" }, "Restore a teammate who can take another meaningful fight and preserve armor value.", "Do not cross an exposed lane just to heal. Ask whether the healed player can actually rejoin the round.", { videoId: "XtmXACKYEZw", title: "How To Play SAGE Like A RADIANT (Valorant Tips)" }),
        ability("resurrection", "Resurrection", "X - Ultimate", "sage", "Revive a dead ally after a vulnerable channel and return them at full health.", { Cost: "7 ultimate points", Charges: "1", Health: "Full health", Damage: "None" }, "Recover a key weapon, restore numbers, or force defenders to contest the body.", "Clear the body and name the revived player's escape route first. A resurrection that immediately dies spends the ultimate without restoring pressure.", { videoId: "XtmXACKYEZw", title: "How To Play SAGE Like A RADIANT (Valorant Tips)" })
      ]
    },
    {
