  ...
  const agents = [
    ...
    },
    {
      ...
      abilities: [
        ...
        ability("paranoia", "Paranoia", "Q - Basic", "omen", "A wall-piercing projectile that Nearsights and Deafens everyone it touches.", { Cost: "250 credits", Charges: "1", Debuff: "About 2 seconds", Damage: "None" }, "Start a coordinated swing through a narrow lane or disable a defender holding behind cover.", "Call the path before casting. It can hit teammates, so align the projectile beside their approach rather than through them.", riotAbilityVideo("https://cmsassets.rgpub.io/sanity/files/dsfx7636/game_data/f401fc788f3182b6d5aa25af6056c842117b1b36.mp4?accountingTag=VAL", "Omen Paranoia ability demo")),
