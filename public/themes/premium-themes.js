(function () {
  ...
  function getPremiumThemesForProfile(profile = {}, flags = window.RANKEDCOACH_FEATURES || {}) {
  ...
  function getPremiumThemeById(id, profile = {}, flags = window.RANKEDCOACH_FEATURES || {}) {
    return getPremiumThemesForProfile(profile, flags).find(theme => theme.id === id) || null;
  }

  window.RankedCoachPremiumThemes = {
    PREMIUM_THEMES,
